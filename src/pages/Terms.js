...
export default function Terms() {
  return (
    <div className="w-full h-full bg-primary flex flex-col items-center pb-5">
      <div className="w-full h-1/6">
        <div className="w-full h-3/5 flex bg-primary-light items-center">
      ...
      <div className="w-5/6 h-5/6 flex bg-primary-light items-center overflow-y-auto p-2 text-wrap">
        Our Terms and Conditions were last updated on [DATE]. Please read these
        ...
        managing authority. ● “Account” means a unique account created for You
        to access our Service or parts of our Service. ● “Company” (referred to
        as either "the Company", "We", "Us" or "Our" in this Agreement) refers
        to [COMPANY_INFORMATION]. ● “Country” refers to [COMPANY_COUNTRY]. ●
        ...
        tablet. ● “Feedback” means feedback, innovations or suggestions sent by
        You regarding the attributes, performance or features of our Service. ●
        “Products” refer to the products or items offered for sale on the
        Service. ● “Orders” mean a request by You to purchase Products from Us.
        ...
        was generated by TermsFeed Terms and Conditions Generator. ●
        ...
        Service. ● “Website” refers to [WEBSITE_NAME], accessible from
        [WEBSITE_URL] ● “You” means the individual accessing or using the
        ...
        before using Our Service. User Accounts When You create an account with
        Us, You must provide Us information that is accurate, complete, and
        ...
        Service. You are responsible for safeguarding the password that You use
        to access the Service and for any activities or actions under Your
        password, whether Your password is with Our Service or a Third-Party
        Social Media Service. You agree not to disclose Your password to any
        ...
        Content Your Right to Post Content Our Service allows You to post
        ...
        other rights of any person. Content Restrictions The Company is not
        ...
        or any third person using Your account. You may not transmit any Content
        that is unlawful, offensive, upsetting, intended to disgust,
        ...
        the following: ● Unlawful or promoting unlawful activity. ● Defamatory,
        discriminatory, or mean-spirited content, including references or
        commentary about religion, race, sexual orientation, gender,
        national/ethnic origin, or other targeted groups. ● Spam, machine – or
        ...
        or any form of lottery or gambling. ● Containing or installing any
        ...
        person. ● Infringing on any proprietary rights of any party, including
        ...
        its employees or representatives. ● Violating the privacy of any third
        person. ● False information and features. The Company reserves the
        right, but not the obligation, to, in its sole discretion, determine
        ...
        challenged content from the Service. Placing Orders for Products By
        placing an Order for Products through the Service, You warrant that You
        are legally capable of entering into binding contracts. Your Information
        ...
        of facilitating the completion of Your Order. Order Cancellation We
        reserve the right to refuse or cancel Your Order at any time for certain
        reasons including but not limited to: ● Products availability ● Errors
        in the description or prices for Products ● Errors in Your Order We
        ...
        Products on the Service. The Products available on Our Service may be
        mispriced, described inaccurately, or unavailable, and We may experience
        delays in updating information regarding our Products on the Service and
        in Our advertising on other websites. We cannot and do not guarantee the
        accuracy or completeness of any information, including prices, product
        images, specifications, availability, and services. We reserve the right
        to change or update information and to correct errors, inaccuracies, or
        omissions at any time without prior notice. Prices Policy The Company
        reserves the right to revise its prices at any time prior to accepting
        an Order. The prices quoted may be revised by the Company subsequent to
        ...
        right to cancel Your Order. Payments Payment can be made through various
        payment methods we have available, such as Visa, MasterCard, Affinity
        Card, American Express cards or online payment methods (PayPal, for
        example). Payment cards (credit cards or debit cards) are subject to
        validation checks and authorization by Your card issuer. If we do not
        receive the required authorization, We will not be liable for any delay
        or non-delivery of Your Order. Promotions Any Promotions made available
        through the Service may be governed by rules that are separate from
        these Terms. If You participate in any Promotions, please review the
        ...
        Intellectual Property The Service and its original content (excluding
        Content provided by You or other users), features and functionality are
        ...
        written consent of the Company. Your Feedback to Us You assign all
        rights, title and interest in any Feedback You provide the Company. If
        for any reason such assignment is ineffective, You agree to grant the
        Company a non-exclusive, perpetual, irrevocable, royalty free, worldwide
        right and license to use, reproduce, disclose, sub-license, distribute,
        modify and exploit such Feedback without restriction. Links to Other
        ...
        discontinue using the Service. Limitation of Liability Notwithstanding
        ...
        purchased anything through the Service. To the maximum extent permitted
        by applicable law, in no event shall the Company or its suppliers be
        ...
        personal injury, loss of privacy arising out of or in any way related to
        ...
        of a breach constitute a waiver of any subsequent breach. Changes to
        ...
        [WEBSITE_CONTACT_PAGE_URL] ● By sending us an email:
