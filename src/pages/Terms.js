...
export default function Terms() {
  ...
  return (
    <div className="w-full h-full bg-primary flex flex-col items-center pb-5">
      ...
      <div className="w-5/6 h-5/6 flex flex-col bg-primary-light items-center overflow-y-auto py-12 px-24 text-wrap">
        ...
        <p className="font-sans  text-secondary self-start font-light text-sm">
          ...
          <li>
            ...
            the Service. This Terms and Conditions Agreement was generated by
        ...
        <p className="font-sans text-secondary self-start font-light text-sm">
          ...
          Conditions then You may not access the Service. <br />
          <br />
        ...
        <p className="font-sans text-secondary self-start font-light text-sm">
          ...
          ([COPYRIGHT_AGENT_CONTACT_EMAIL]). Upon receipt of a notification, the
        ...
        <p className="font-sans text-secondary self-start font-light text-sm">
          ...
          advertising on other websites. <br /> <br /> We cannot and do not
        ...
        <p className="font-sans text-secondary self-start font-light text-sm">
          ...
          through any such web sites or services. <br /> We strongly advise You
