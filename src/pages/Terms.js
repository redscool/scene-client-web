    ...
    <div className="w-full h-full bg-primary flex flex-col items-center">
      ...
      <div className="w-full h-5/6 flex flex-col items-center overflow-y-scroll">
        <div className="w-5/6 flex flex-col bg-primary-light items-center mt-16 py-12 px-24 text-wrap">
          ...
          <p className="font-sans text-secondary self-start font-light text-sm">
            <br />
            Our Terms and Conditions were last updated on {date}. <br />
          ...
          <p className="font-sans  text-secondary self-start font-light text-sm">
            ...
            <li>
              <span className="font-medium">“Feedback”</span> means feedback,
              innovations or suggestions sent by You regarding the attributes,
              performance or features of our Service.
            </li>
            <li>
              <span className="font-medium"> “Products” </span> refer to the
              products or items offered for sale on the Service.
            </li>
            <li>
              <span className="font-medium"> “Orders” </span> mean a request by
              You to purchase Products from Us.
            </li>
            <li>
              <span className="font-medium"> “Promotions” </span>refer to
              contests, sweepstakes or other promotions offered through the
              Service.
            </li>
            <li>
          ...
          <p className="font-sans text-secondary self-start font-light text-sm">
            ...
            <br /> <li> Products availability </li>
          ...
          <p className="font-sans text-secondary self-start font-light text-sm">
            ...
            Our advertising on other websites. <br /> <br /> We cannot and do
          ...
          <p className="font-sans text-secondary self-start font-light text-sm">
            ...
            that are not owned or controlled by the Company. <br /> The Company
            ...
            on or through any such web sites or services. <br /> We strongly
